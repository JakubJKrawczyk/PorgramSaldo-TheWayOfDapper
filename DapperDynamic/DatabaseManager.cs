...
//TODO: dodać kalsę z golbalnymi użyciami bibliotek systemowych
    ...
    public class DatabaseManager
{
    ...
    private static string _generateRealName(bool column = false)
    {
        ...
        //TODO: Przerobić wszystkie funkcje pod aktualną baze danych
        ...
        public bool ProcessLogin(string login, string password)
    {
            return HandleInTransaction(() =>
            {
                ...
                string querry = "SELECT Username, Password FROM User where Username = @login";
